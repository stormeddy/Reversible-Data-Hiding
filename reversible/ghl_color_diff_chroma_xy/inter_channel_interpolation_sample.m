function [ICh3]=inter_channel_interpolation_sample(Ch3,Ch1,Ch2,M,N)
    Ch1=double(Ch1);
    Ch2=double(Ch2);
    Ch3=double(Ch3);
    ICh3=Ch3;
    ...
    for i=[1,ver_max]
        for j=1:2:hor_max
            ...
            if i==1
                if j==1
                    ...
                    C3=[Ch3(i,j+1),Ch3(i+1,j)];
                        ...
                        % top edge
                        C1=[Ch1(i,j-1),Ch1(i,j+1),Ch1(i+1,j)];
                        C2=[Ch2(i,j-1),Ch2(i,j+1),Ch2(i+1,j)];
                        C3=[Ch3(i,j-1),Ch3(i,j+1),Ch3(i+1,j)];
                    end
                end
            else if i==m
                    if j==1
                        % left-bottom corner
                        C1=[Ch1(i-1,j),Ch1(i,j+1)];
                        C2=[Ch2(i-1,j),Ch2(i,j+1)];
                        C3=[Ch3(i-1,j),Ch3(i,j+1)];
                    else if j==n
                            % right-bottom corner
                            C1=[Ch1(i-1,j),Ch1(i,j-1)];
                            C2=[Ch2(i-1,j),Ch2(i,j-1)];
            ...
            ICh3(i,j)=inter_channel_local_estimation(c1,c2,C1,C2,C3,M,N);
        end
    end
