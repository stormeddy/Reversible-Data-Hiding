...
%     I=imread('lena.pgm');
    ...
    while true
        ...
        [AEI,ratio,num]=general_embed(pre_AEI,u,v,msb,add_bits,permutation_key,encryption_key,data_hiding_key,k&1);
        ratio
        if k==1 && ratio<0
    ...
    while k>1        
        ...
        [RI,extracted_bits]=general_extract(RI,u,v,msb,permutation_key,encryption_key,data_hiding_key,k&1);
