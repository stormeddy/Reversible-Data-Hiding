...
%     I=imread('49.pgm');
    ...
    % embed bits
    [AEI1,ratio1,num]=general_embed(I,u,v,msb,add_bits,permutation_key,encryption_key,data_hiding_key,1);
    
    add_bits=randi([0 1],numel(I),1);
    [AEI2,ratio2,num]=general_embed(AEI1,u,v,msb,add_bits,permutation_key,encryption_key,data_hiding_key,0);
    REI2=AEI2;
