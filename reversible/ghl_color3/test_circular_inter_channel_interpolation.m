...
for cnt=1:10
    ...
    for i=1:10
        ...
        Ch2=B;
        Ch3=G;
        [ICh3]=inter_channel_interpolation_non_sample(Ch3,Ch1,Ch2,N);        
        PSNR1_3=psnr(uint8(ICh3),Ch3);
        
        [ICh2]=inter_channel_interpolation_non_sample(Ch2,ICh3,Ch1,N);
        PSNR1_2=psnr(uint8(ICh2),Ch2);
        
        [ICh1]=inter_channel_interpolation_non_sample(Ch1,ICh2,ICh3,N);
