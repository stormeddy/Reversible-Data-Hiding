function [RI,extract_bits]=general_extract(AI2,interp_l,interp_r,ref_l,ref_r,Ch1,Ch2,N)
    % interpolate sample pixels
%     [RP]=inter_channel_interploation_sample(AI2,Ch1,Ch2,N);
    [RP]=inter_channel_interpolation_sample(AI2,Ch1,Ch2,N);
    [AI1,extract_bits2]=data_extraction_sample(AI2,RP,ref_l,ref_r);
    
    % interpolate non-sample pixels
    [IP]=inter_channel_interpolation_non_sample(AI1,Ch1,Ch2,N);
