...
save([save_path 'single_reversibility_ucid.mat'],'reversibility');
...
save([save_path 'single_all_ratio_ucid.mat'],'all_ratio_ucid');
save([save_path 'single_all_psnr_ucid.mat'],'all_psnr_ucid');
