function [AI2,num,ratio,interp_l,interp_r,ref_l,ref_r]=general_embed(Ch3,Ch1,Ch2,M,add_bits,N)
    Ch1=double(Ch1);
    Ch2=double(Ch2);
    Ch3=double(Ch3);
    % shrink histogram
    ...
    [IP]=inter_channel_interpolation_non_sample(SCh3,Ch1,Ch2,M,N);
...
%     [RP]=inter_channel_interploation_sample(Ch3,AI1,Ch2,N);  %wrong!
    [RP]=inter_channel_interpolation_sample(AI1,Ch1,Ch2,M,N);
    % embed bits into non-sample pixels
