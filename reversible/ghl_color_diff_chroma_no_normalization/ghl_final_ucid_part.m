...
save_path='data\';
save([save_path 'img_equal_final_ucid_part.mat'],'img_equal_final_ucid');
save([save_path 'bit_equal_final_ucid_part.mat'],'bit_equal_final_ucid');
save([save_path 'reversibility_final_ucid_part.mat'],'reversibility_final_ucid');
save([save_path 'num_final_ucid_part.mat'],'num_final_ucid');
save([save_path 'ratio_final_ucid_part.mat'],'ratio_final_ucid');
save([save_path 'psnr_final_ucid_part.mat'],'psnr_final_ucid');
save([save_path 'all_ratio_final_ucid_part.mat'],'all_ratio_final_ucid');
save([save_path 'all_psnr_final_ucid_part.mat'],'all_psnr_final_ucid');
save([save_path 'flag_ucid_part.mat'],'flag_ucid');