...
riwuit_non_sample_psnr_ucid=zeros(Num,3);
ghl_non_sample_psnr_ucid=zeros(Num,3);
...
for i=1:Num
    ...
    for j=1:3
        ...
        riwuit_non_sample_psnr_ucid(i,j)=psnr(uint8(IP),uint8(SCh3));
    ...
    for j=1:3
        ...
        ghl_non_sample_psnr_ucid(i,j)=psnr(uint8(IP),uint8(SCh3));
...
% save([save_path 'riwuit_non_sample_psnr_ucid.mat'],'riwuit_non_sample_psnr_ucid');
% save([save_path 'ghl_non_sample_psnr_ucid.mat'],'ghl_non_sample_psnr_ucid');